            ...
            <div class="row-fluid table">
                <table class="table table-hover">
                    ...
                    <tr>
                        ...
                        <th class="span3">
                            <span class="line"></span>最后访问时间
                        </th>
                        <th class="span3">
                            <span class="line"></span>最后访问IP
                        </th>
                        <th class="span3">
                    ...
                    <tr class="first">
                        <td>
                            <?php echo $manage->adminid ?>
                        </td>
                        <td>
                            <?php echo $manage->adminuser; ?>
                        </td>
                        <td>
                            <?php echo $manage->adminemail; ?>
                        </td>
                        <td>
                            <?php echo date('Y-m-d H:i',$manage->logintime); ?>
                        </td>
                        <td>
                            <?php echo long2ip($manage->loginip); ?>
                        </td>
                        <td>
                            <?php echo date('Y-m-d H:i',$manage->createtime); ?>
                        </td>
